...
template "#{node["stalltalk"]["project_path"]}/.env" do
  ...
  variables({
    ...
    default_file_storage: node["stalltalk"]["storage"]["default_file_storage"],
    staticfiles_storage: node["stalltalk"]["storage"]["staticfiles_storage"],
    aws_access_key_id: node["stalltalk"]["storage"]["aws_access_key_id"],
    aws_secret_access_key: node["stalltalk"]["storage"]["aws_secret_access_key"],
    aws_storage_bucket_name: node["stalltalk"]["storage"]["aws_storage_bucket_name"],
  })
end
